---
mode: 'agent'
description: 'Answers questions about authoring Playback tapes — writing scripts, recording videos, understanding outputs, and finding features.'
---
...
The default voice is `northern_english_male`. Find the voice catalogue in `~/.config/playback/voices.yaml`. To use a different voice, set it in `meta.yaml`:
